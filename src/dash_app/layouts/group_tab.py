...
def _create_group_pep_table() -> dash_table.DataTable:
    """グループPEPテーブルを生成する"""
    return dash_table.DataTable(
        ...
        style_cell_conditional=[
            ...
            {"if": {"column_id": "in_degree"}, "minWidth": "30px", "width": "30px", "textAlign": "right"},
            {"if": {"column_id": "out_degree"}, "minWidth": "30px", "width": "30px", "textAlign": "right"},
            {"if": {"column_id": "degree"}, "minWidth": "30px", "width": "30px", "textAlign": "right"},
            {"if": {"column_id": "pagerank"}, "minWidth": "30px", "width": "30px", "textAlign": "right"},
        ],
        style_data={
            "lineHeight": "1.1",

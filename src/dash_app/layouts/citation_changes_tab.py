        ...
        [
            ...
            dash_table.DataTable(  # type: ignore[attr-defined]
                ...
                columns=[
                    ...
                    {"name": "Cited", "id": "cited", "type": "numeric"},
                    {"name": "Cited Title", "id": "cited_title", "type": "text"},
                    {"name": "Citing", "id": "citing", "type": "numeric"},
                    {"name": "Citing Title", "id": "citing_title", "type": "text"},

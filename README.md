...
Each group is assigned a name and description generated by an AI model.
These are displayed in the top-right panel.

**Note:**
- The generated names and descriptions may contain inaccuracies or omissions. They are provided for reference only.
- This feature is currently in beta. Group names and descriptions are available only in Japanese for now. English names and descriptions are planned for a future update.

![](images/groups/group_profile.png)
